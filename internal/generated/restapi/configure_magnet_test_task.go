...
//go:generate swagger generate server --target ../../generated --name MagnetTestTask --spec ../../../swagger-api/swagger.yaml --template-dir ./swagger-templates/templates --principal interface{}

func configureFlags(api *operations.MagnetTestTaskAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.MagnetTestTaskAPI) http.Handler {
